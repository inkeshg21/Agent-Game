...
using UnityEngine;
public class PathfindingTesterAgent3 : MonoBehaviour
{
    // ant colony
    ACOTesterAgent3 ACOTesterAgent3 = new ACOTesterAgent3();
    // The A* manager.
    ...
    //For speed
    [HideInInspector]
    public ACOTesterAgent3 speednext;
    float colidespeed;
    ...
    public void Start()
    {
        speednext = FindObjectOfType<ACOTesterAgent3>();
        colidespeed = speednext.finalSpeed;
        this.GetComponent<ACOTesterAgent3>().enabled = false;
        ...
        ACOTesterAgent3.rb = GetComponent<Rigidbody>();
        ACOTesterAgent3.rb.MovePosition((ConnectionArray[0].GetFromNode().transform.position + ACOTesterAgent3.OffSet));
    ...
    void OnDrawGizmos()
    {
        ...
        foreach (Connection aConnection in ConnectionArray)
        {
            ...
            Gizmos.DrawLine((aConnection.GetFromNode().transform.position + ACOTesterAgent3.OffSet),
            (aConnection.GetToNode().transform.position + ACOTesterAgent3.OffSet));
    ...
    {
        speednext = FindObjectOfType<ACOTesterAgent3>();
        // Debug.Log(speednext.finalSpeed);
        // ACOTesterAgent3.finalSpeed = 100f;
