...
using UnityEngine;
public class PathfindingTesterAgent2 : MonoBehaviour
{
    // ant colony
    ACOTesterAgent2 ACOTesterAgent2 = new ACOTesterAgent2();
    // The A* manager.
    ...
    //For speed
    [HideInInspector]
    public ACOTesterAgent2 speednext;
    float colidespeed;
    ...
    public void Start()
    {
        speednext = FindObjectOfType<ACOTesterAgent2>();
        colidespeed = speednext.finalSpeed;

        this.GetComponent<ACOTesterAgent2>().enabled = false;
        ...
        ACOTesterAgent2.rb = GetComponent<Rigidbody>();
        ACOTesterAgent2.rb.MovePosition((ConnectionArray[0].GetFromNode().transform.position + ACOTesterAgent2.OffSet));
    ...
    void OnDrawGizmos()
    {
        ...
        foreach (Connection aConnection in ConnectionArray)
        {
            ...
            Gizmos.DrawLine((aConnection.GetFromNode().transform.position + ACOTesterAgent2.OffSet),
            (aConnection.GetToNode().transform.position + ACOTesterAgent2.OffSet));
