...
{
    //List of all coneections for the node.
    ...
    //Draws debug objects in the editor and during ecitor play (if option set).
    void OnDrawGizmos()
    {
        if (ObjectSelected)
        {
    ...
    //Draws debug objests when an object id selected.
